...
struct Cleaner: Codable {
    var visitID, homeBobEmployeeID, houseOwnerID: String?
    var isBlocked: Bool?
    var startTimeUTC, endTimeUTC, title: String?
    var isReviewed, isFirstVisit, isManual: Bool?
    var visitTimeUsed: Int?
    var rememberToday: JSONNull?
    var houseOwnerFirstName, houseOwnerLastName, houseOwnerMobilePhone, houseOwnerAddress: String?
    var houseOwnerZip, houseOwnerCity: String?
    var houseOwnerLatitude, houseOwnerLongitude: Double?
    var isSubscriber: Bool?
    var rememberAlways: JSONNull?
    var professional, visitState: String?
    var stateOrder: Int?
    var expectedTime: String?
    var tasks: [Task]?
    var houseOwnerAssets, visitAssets, visitMessages: [JSONAny]?
...
extension CleanerData {
    
    static var all: Resource<CleanerData> {
        guard let path = Bundle.main.path(forResource: "carfit", ofType: "json") else { fatalError() }
        return Resource<CleanerData>(url: URL(fileURLWithPath: path))
    }
}
// MARK: - Task
struct Task: Codable {
    ...
    var isTemplate: Bool?
    var timesInMinutes, price: Int?
    var paymentTypeID, createDateUTC, lastUpdateDateUTC: String?
    var paymentTypes: JSONNull?
